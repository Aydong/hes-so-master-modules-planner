  ...
  <div className="bg-red-50 border border-red-100 rounded-xl p-4 mb-8 flex gap-3 text-sm text-red-800 shadow-sm">
    ...
    <div className="space-y-2">
      <p className="font-medium">
        Information updated June 2026 (17.06.2026) based on official HES-SO
        data.
      </p>
      <p className="text-red-700/80">
        Brasov modules for the ICS - Information and Cybersecurity program are
        currently not available in this app.
      </p>
      <p className="text-red-700/80">
        This is an <b>unofficial</b> tool created by a student for students. It
        is not affiliated with MSE and may not be 100% accurate.
        <br />
        Always double-check with official sources and your academic advisor
        before making decisions based on this planner.
        <br />
